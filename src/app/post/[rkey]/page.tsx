...
export async function generateMetadata({
  ...
  return {
    title: `${entry.title} — ${config.metadata.title}`,
    authors: [{ name: config.metadata.name, url: `https://bsky.app/profile/${MY_DID}` }],
    description: `by ${config.metadata.name} · ${readingTime(entry.content).text}`, 
  };
}
